        ...
        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-6 mb-5">
            ...
            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                ...
                <span class="menu-link">
										...
										<span class="menu-title">{{__('app.telegram_bot')}}</span>
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link active" href="{{route('chats.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                            <span class="menu-title">{{__('app.chat_members')}}</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
            ...
            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                ...
                <span class="menu-link">
										...
										<span class="menu-title">{{__('app.services')}}</span>
										<span class="menu-arrow"></span>
									</span>
                <!--end:Menu link-->
                <!--begin:Menu sub-->
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link active" href="{{route('sms-providers.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                            <span class="menu-title">{{__('app.sms_providers')}}</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
